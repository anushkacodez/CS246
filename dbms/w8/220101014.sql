...
where student.roll_number=marks.roll_number
and marks.set1=c1.qn
and marks.cid=c1.cid
and marks.set2=c2.qn
and marks.cid=c2.cid;

-- 5
select marks.roll_number, course.cname, c1.cid, set1, c1.description, set1_marks, set2, c2.description, set2_marks
from marks, course, concept as c1, concept as c2
where marks.set1=c1.qn
and marks.cid=c1.cid
and marks.set2=c2.qn
and marks.cid=c2.cid
and marks.cid=course.cid;

-- 6
(select distinct student_name
from student natural join marks natural join course
where cname='Introduction to Data Science')
intersect 
(select distinct student_name
from student natural join marks natural join course
where cname='Computer System Tools');
...
where cname='Python Programming')
intersect 
(select distinct roll_number
from marks natural join course
where cname='Computer System Tools')
